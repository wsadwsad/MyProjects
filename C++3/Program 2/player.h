...
class Player
{
  public:
    ...
    //This function check a players hand for pairs.
    //If a pair is found, it returns trun and remove those two cards from hand and book them.
    bool checkPairFromHand();
